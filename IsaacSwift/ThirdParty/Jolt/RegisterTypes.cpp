...
// HairSettings registration removed: the Hair module is excluded in IsaacSwift.
...
void RegisterHair()
{
	// HairSettings is intentionally not registered: the Hair module is excluded
	// from this iOS build because it depends on Jolt's GPU compute backends.
}
